            ...
            {softwareResource?.recipient_third_parties?.map(
              (rtp: any, i: number) => (
                <React.Fragment key={rtp?.party_name + i}>
                  <div>
                    <p className={Styles.textBold}>Party name</p>
                    <p>{rtp?.party_name}</p>
                  </div>
                  <div>
                    <p className={Styles.textBold}>Party type</p>
                    <p>{rtp?.party_type}</p>
                  </div>
                  <div>
                    <p className={Styles.textBold}>Party address</p>
                    <p>{rtp?.party_address}</p>
                  </div>
                  {rtp?.party_role && (
                    <div>
                      <p className={Styles.textBold}>Party role</p>
                      <p>{rtp?.party_role}</p>
                    </div>
                  )}
                  {rtp?.party_email && (
                    <div>
                      <p className={Styles.textBold}>Party email</p>
                      <p>{rtp?.party_email}</p>
                    </div>
                  )}
                  {rtp?.party_url && (
                    <div>
                      <p className={Styles.textBold}>Party url</p>
                      <p>{rtp?.party_url}</p>
                    </div>
                  )}
                  {rtp?.party_phone && (
                    <div>
                      <p className={Styles.textBold}>Party phone</p>
                      <p>{rtp?.party_phone}</p>
                    </div>
                  )}
                </React.Fragment>
