  ...
  const renderHeader = () => {
    const defaultHeader = (
      <>
        ...
        <h3 className={Styles.purpose}>{privacyNotice?.purposes?.[0]?.name}</h3>
      </>
    );
    const learnMoreHeader = (
      <h3 className={Styles.purpose}>Discover how your data will be used</h3>
    );
    const legalHeader = (
      <>
        <h3 className={Styles.purpose}>Legal aspects of your consent</h3>
        <p>
          Understanding your data rights empowers you to take control of your
    ...
    const successHeader = <h3>Congrat you consent was successfuly create.</h3>;
